...
From each distribution we simulate 100,000 random draws and use them to generate a posterior distribution
...
#use Monte Carlo simulation to generate prior and posterior distribution for females minus males
diff_prior <- rbeta(100000, a_female, b_female) - rbeta(100000, a_male, b_male)
diff_post <- rbeta(100000, a_star_female, b_star_female) - rbeta(100000, a_star_male, b_star_male)
