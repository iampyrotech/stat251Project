...
First of all, in order to preform our analysis we obtain the posterior distributions for $\theta_{male}$. The graph below displays the prior and posterior distribution for males. We also obtain the posterior distribution for females and graph the prior and posterior for it.
...
We obtained a 95% credible interval of the posterior of (-0.074 and -0.017). There is a 95% probability that the difference in proportions of fatal shark attacks for males and females is between -0.074 and -0.017.
